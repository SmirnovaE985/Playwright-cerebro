...
Проект  **Cerebro** — рабочего места менеджера контакт-центра. Демонстрация комплексного подхода к автоматизированному тестированию веб‑приложения на базе фреймворка Playwright. Проект представляет собой адаптированную версию боевых тестов из коммерческого решения, оптимизированную для публичного репозитория. 
