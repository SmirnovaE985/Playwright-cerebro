...
test(
  ...
  async ({ page }) => {
    ...
    //   await orderCreatePage.getModalPositionCostNormalized();

    await orderCreatePage.addButtonInCart();
    await orderCreatePage.addToCart();
    await orderCreatePage.openCartPosition();
    await orderCreatePage.changeUnitDataLoc('[data-test="unit-PM"]');
    await orderCreatePage.saveEditedPosition();
    ...
    await orderCreatePage.openCartPosition();
    await orderCreatePage.changeUnitDataLoc('[data-test="unit-ROL"]');
    await orderCreatePage.saveEditedPosition();
    await orderCreatePage.makeOrder();
    await orderCreatePage.expectOrderCreatedSuccess();
    ...
    // await orderCreatePage.expectCartTotalCostToBe(productCardTotal);
    // const cartTotalCost = await orderCreatePage.getCartTotalCostNormalized();
